...
public class MojoExecutor
{
	...
	public static void executeMojo(Plugin plugin, String goal, XmlPlexusConfiguration configuration, ExecutionEnvironment env)
			throws MojoExecutionException, MojoFailureException
	{
		executeMojo(plugin, goal, PlexusConfigurationUtils.toXpp3Dom(configuration), env);
	}
